  ...
  return (
    <div>
      ...
      <div className="animate-section">
        <h2 className="animate-heading">What is Genesis ?</h2>
        <p className="animate-para">
          Genesis is a decentralized file storage system that uses
          ...
          Genesis, data management becomes decentralized and transparent, a
      ...
      <div className="about">
        ...
        <p className="about-text">
          At Genesis, we believe that data ownership and privacy are
